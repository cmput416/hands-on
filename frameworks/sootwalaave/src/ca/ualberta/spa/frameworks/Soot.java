...
//		applyVTA();
	...
	private static void dumpPAG() {
		...
		if (pts instanceof PAG) {
			PAG pag = (PAG) pts;
			System.out.println("VarNodes: " + format(pag.getVarNodeNumberer().size()));
			System.out.println("FieldRefNodes: " + format(pag.getFieldRefNodeNumberer().size()));
			System.out.println("AllocNodes: " + format(pag.getAllocNodeNumberer().size()));
			System.out.println();
		}
	...
	private static void dumpCG() {
		...
		System.out.println();
		System.out.println();
		System.out.println("The call graph has " + format(cg.size()) + " edges.");
		System.out.println();
